...
class Agent:
    def __init__(self):
        self.n_games = 0
        self.epsilon = 0.1  # случайность
        self.gamma = 1  # коэффициент дисконтирования
    ...
    def get_state(self, game):
        ...
        state = [
            ...
            game.food.x < game.head.x,  # еда слева
            game.food.x > game.head.x,  # еда справа
            game.food.y < game.head.y,  # еда сверху
            game.food.y > game.head.y   # еда снизу
        ]
